...
const th: Strings = {
  ...
  cities: {
    ...
    sf: {
      ...
      years: "2018 – 2022",
      text: "ผมเป็น Senior Technical PM ที่ Lyft และต่อมาที่ Asana ดูแลงานโครงสร้างพื้นฐาน แพลตฟอร์มข้อมูล และความเร็วในการพัฒนา สำหรับผลิตภัณฑ์ดิจิทัลที่มีผู้ใช้หลายล้านคน",
      linkLabel: "ดูประสบการณ์ →",
    },
    seattle: {
      name: "ซีแอตเทิล",
  ...
  facets: {
    ...
    strategy: {
      ...
      blurb:
        "เชื่อมทุกการตัดสินใจเรื่องผลิตภัณฑ์ดิจิทัลเข้ากับรายได้ ต้นทุน และทิศทางของบริษัท แล้วเลือกว่าจะสร้างอะไร และที่ยากกว่าคือเลือกว่าจะไม่ทำอะไร",
      proof:
    ...
    insight: {
      ...
      blurb: "วาง roadmap ผลิตภัณฑ์ดิจิทัลจากตัวเลขจริงและปัญหาของผู้ใช้จริง",
      proof:
    ...
    execution: {
      ...
      blurb:
        "เปลี่ยนกลยุทธ์ให้เป็นผลิตภัณฑ์ดิจิทัลที่ส่งได้เร็วและใช้งานได้จริง โดยให้ผู้บริหาร วิศวกรรม ดีไซน์ และทีมขายและการตลาด มองเห็นภาพเดียวกันและเดินไปในทิศทางเดียวกัน",
      proof:
        "ผมขับเคลื่อนการปฏิบัติตาม GDPR ทั่วทั้ง Microsoft Office โดยประสานงานองค์กรขนาด 5,000 คน เพื่อส่งมอบสิทธิ์ในการลบและส่งออกข้อมูล และผมยังทำให้ผลิตภัณฑ์ดิจิทัลออกสู่ตลาดได้เร็ว เช่น ร่วมกับทีมส่งมอบ integration กว่า 200 ตัวในหกเดือนที่ Vanta และลดเวลา build และ deploy จากหลายวันเหลือไม่กี่นาทีที่ Atlan",
    },
  },
  work: {
  ...
  roles: {
    ...
    vanta: {
      ...
      bullets: [
        "กำหนดและดำเนินกลยุทธ์ผลิตภัณฑ์ดิจิทัลสำหรับแพลตฟอร์มเก็บหลักฐานอัตโนมัติของ Vanta โดยประสานงานข้ามทีมทั้งผู้บริหาร วิศวกรรม และดีไซน์",
    ...
    mt: {
      ...
      bullets: [
        "ร่วมงานกับธนาคารและทีมขายเพื่อประเมินผลกระทบด้านการสร้างรายได้ ธุรกิจ และผลิตภัณฑ์ดิจิทัล จากความน่าเชื่อถือที่สูงขึ้นและมาตรฐาน compliance ทางการเงินใหม่",
  ...
  teaching: {
    ...
    paragraphs: [
      "ทุกปีผมกลับกรุงเทพฯ หนึ่งสัปดาห์เพื่อสอนใน{strong}หลักสูตร LLBel ที่จุฬาลงกรณ์มหาวิทยาลัย{/strong} ซึ่งเป็นบูตแคมป์เข้มข้นสำหรับนิสิตคณะนิติศาสตร์ ผมสอนการจัดการผลิตภัณฑ์ดิจิทัล การคิดเชิงออกแบบ และเล่าว่าวงการเทคโนโลยีทำงานกันอย่างไร เพื่อให้นักกฎหมายและผู้กำกับดูแลในอนาคตเข้าใจระบบที่พวกเขาจะให้คำปรึกษาและกำกับดูแล",
      "ต่อเนื่องมาสี่ปีแล้ว งานสอนใช้ทักษะเดียวกับงานผลิตภัณฑ์ดิจิทัล คือการหยิบเรื่องซับซ้อนมาทำให้อีกคนเข้าใจได้",
    ],
  ...
  flashcards: [
    {
      ...
      back: "ผมสอนนิสิตคณะนิติศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย เนื้อหาแนะนำการจัดการผลิตภัณฑ์ดิจิทัล กลยุทธ์ธุรกิจ การทดลอง บริษัทเทคโนโลยี และแนวคิดการเขียนโค้ดพื้นฐาน ผ่านกิจกรรมที่ได้ลงมือทำและมีส่วนร่วม",
    },
    {
      front: "ทำไมนักศึกษากฎหมายจึงควรเรียนธุรกิจและเทคโนโลยี?",
      back: "นักกฎหมายในอนาคตจะต้องให้คำปรึกษา กำกับดูแล และทำงานกับบริษัทเทคโนโลยีมากขึ้นเรื่อย ๆ การเข้าใจว่าบริษัทเหล่านี้สร้างผลิตภัณฑ์ดิจิทัล ตัดสินใจ และตอบสนองต่อแรงจูงใจอย่างไร ช่วยให้นักศึกษาให้คำปรึกษาทางกฎหมายได้อย่างเป็นรูปธรรมและออกแบบการกำกับดูแลที่ได้ผลกว่าเดิม",
    },
    {
  ...
  chat: {
    ...
    suggested: [
      ...
      "เขาเคยทำผลิตภัณฑ์ดิจิทัลด้าน compliance ไหม?",
