...
const th: Strings = {
  ...
  cities: {
    ...
    seattle: {
      ...
      kicker: "ปัจจุบัน",
      years: "2022 – ปัจจุบัน",
      text: "ผมเคยทำงานที่ Modern Treasury และ Vanta และล่าสุดเป็น Staff PM ที่ Atlan ซึ่งผมได้สร้างแพลตฟอร์มด้านการปฏิบัติตามข้อกำหนด การเชื่อมต่อระบบ และโครงสร้างพื้นฐานด้าน AI",
      linkLabel: "ดูประสบการณ์ →",
    },
  },
  approach: {
  ...
  facets: {
    technical: {
      ...
      blurb:
        "เข้าใจสถาปัตยกรรม ระบบ และข้อจำกัด มากพอที่จะทำงานร่วมกับวิศวกรและตัดสินใจแลกเปลี่ยนได้อย่างน่าเชื่อถือ",
      proof:
    ...
    strategy: {
      ...
      proof:
        "ผมทำให้สิ่งที่เราส่งมอบผูกกับคุณค่าทางธุรกิจจริงเสมอ ที่ Vanta ผมสร้างความสามารถในการปรับแต่งที่ให้ลูกค้าสร้างการเชื่อมต่อและการทดสอบของตนเองได้ ซึ่งเปิดทาง Vanta สู่ลูกค้าองค์กรขนาดใหญ่และตลาดใหม่ ก่อนหน้านี้ผมขับเคลื่อนการประหยัดต้นทุนหลายล้านดอลลาร์ที่ Lyft และ Microsoft",
    },
    insight: {
      label: "ข้อมูลและความเข้าใจลูกค้า",
      blurb: "วางแผนงานผลิตภัณฑ์จากตัวเลขจริงและปัญหาของผู้ใช้จริง",
      proof:
        "ผมสร้างแพลตฟอร์มการทดลองและ telemetry ของ Office ที่ Microsoft และวางรูปแบบแพลตฟอร์มการเชื่อมต่อของ Vanta รวมถึงการทดสอบแบบกำหนดเองรายแรกของวงการ ผ่านการสัมภาษณ์ผู้ใช้และการวิจัยร่วมกับพาร์ตเนอร์",
    },
    execution: {
      label: "การลงมือทำและการประสานงาน",
      blurb:
        "เปลี่ยนกลยุทธ์ให้เป็นผลิตภัณฑ์ที่ส่งได้เร็วและใช้งานได้จริง โดยให้ผู้บริหาร วิศวกรรม ดีไซน์ และทีมการตลาดพายเรือไปทางเดียวกัน",
      proof:
        "ผมขับเคลื่อนการปฏิบัติตาม GDPR ทั่วทั้ง Microsoft Office โดยประสานงานองค์กรขนาด 5,000 คน เพื่อส่งมอบสิทธิ์ในการลบและส่งออกข้อมูล และผมยังทำให้ผลิตภัณฑ์ออกสู่ตลาดได้เร็ว เช่น ร่วมกับทีมส่งมอบการเชื่อมต่อกว่า 200 รายการในหกเดือนที่ Vanta และลดเวลา build และ deploy จากหลายวันเหลือไม่กี่นาทีที่ Atlan",
    },
  },
  work: {
  ...
  roles: {
    ...
    vanta: {
      ...
      years: "2023 – 2024",
      summary:
        "ที่ยูนิคอร์นด้านความปลอดภัยและการปฏิบัติตามข้อกำหนด ผมดูแลกลยุทธ์ของแพลตฟอร์มเก็บหลักฐานอัตโนมัติ และเปิดตัวการทดสอบและการเชื่อมต่อแบบกำหนดเองรายแรกของวงการ โดยใช้ AI ทำให้การแก้ไขเร็วขึ้น",
      bullets: [
    ...
    mt: {
      ...
      years: "2022 – 2023",
      summary:
        "ที่ยูนิคอร์นด้านการชำระเงินและฟินเทค ผมวางแผนงานสำหรับโครงสร้างพื้นฐาน ความปลอดภัย การปฏิบัติตามข้อกำหนด และเครื่องมือนักพัฒนา",
      bullets: [
    ...
    asana: {
      ...
      years: "2020 – 2022",
      summary:
        "ทำให้แอป Asana รองรับลูกค้าองค์กรได้ ด้วยการดูแลประสิทธิภาพและเวลาโหลด กำหนดเกณฑ์ที่สำคัญ และสร้างเครื่องมือรอบ ๆ เกณฑ์เหล่านั้น",
      bullets: [
        "ดูแลวิสัยทัศน์และแผนงานเพื่อทำให้แอป Asana รองรับลูกค้าองค์กร โดยเน้นเรื่องประสิทธิภาพและเวลาโหลด",
        "กำหนดกลยุทธ์โดยเชื่อมโยงประสิทธิภาพของแอปกับผลกระทบทางธุรกิจผ่านการวิจัย (NPS, การเลิกใช้งาน, การวิเคราะห์คู่แข่ง) และสร้างความเห็นพ้องทั้งบริษัทเรื่องเกณฑ์ที่สำคัญ",
    ...
    lyft: {
      ...
      bullets: [
        ...
        "สร้างความสอดคล้องกับผู้บริหารระดับสูง (CEO, VP Engineering) ด้วยการตรวจสอบตัวชี้วัดสำคัญ และสื่อสารความคืบหน้า ความเสี่ยง และการปรับกลยุทธ์",
    ...
    msft: {
      ...
      bullets: [
        "ตกผลึกข้อกำหนด GDPR ขับเคลื่อนความเชื่อมโยงข้ามทีม และออกแบบระบบข้อมูลเพื่อรองรับสิทธิ์ในการลบและส่งออกข้อมูลตาม GDPR",
    ...
    uoft: {
      ...
      bullets: [
        ...
        "จบการศึกษาด้วยเกรดเฉลี่ย 3.78 / 4.00 พร้อมวิชาโทด้านบริหารวิศวกรรม",
      ],
  ...
  teaching: {
    ...
    cardCounter: (n, total) => `การ์ด ${n} จาก ${total}`,
    prompt: "คำถาม",
    answer: "คำตอบ",
  ...
  flashcards: [
    {
      ...
      back: "ผมสอนนักศึกษากฎหมายชั้นปีที่หนึ่งในหลักสูตร LLBel ที่คณะนิติศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย เนื้อหาแนะนำการบริหารผลิตภัณฑ์ กลยุทธ์ธุรกิจ การทดลอง บริษัทเทคโนโลยี และแนวคิดการเขียนโค้ดพื้นฐาน ผ่านกิจกรรมที่ลงมือทำและมีปฏิสัมพันธ์",
    },
    {
    ...
    {
      front: "คุณทำให้แนวคิดเชิงเทคนิคเข้าใจง่ายสำหรับนักศึกษากฎหมายได้อย่างไร?",
      back: "ผมเน้นการคิดอย่างเป็นระบบมากกว่าศัพท์เทคนิคหรือการท่องจำ นักศึกษาได้เรียนรู้ผ่านการอภิปราย การจำลองสถานการณ์ กิจกรรมกลุ่ม และกรณีจริงที่เชื่อมโยงธุรกิจ เทคโนโลยี กฎหมาย และนโยบายสาธารณะ",
    },
    {
      front: "นักศึกษาได้อะไรจากวิชานี้?",
      back: "นักศึกษาได้พัฒนาทักษะที่ใช้ได้จริงทั้งการคิดเชิงกลยุทธ์ การแก้ปัญหา การทำงานเป็นทีม และการตัดสินใจ อีกทั้งยังมีความมั่นใจที่จะรับมือกับประเด็นเชิงเทคนิคและเชิงพาณิชย์ แม้ไม่มีพื้นฐานด้านธุรกิจหรือวิทยาการคอมพิวเตอร์",
    },
  ],
  photoAlts: {
    teach1: "การสอนที่จุฬาลงกรณ์มหาวิทยาลัย",
    teach2: "บรรยากาศในห้องเรียน",
    teach3: "กิจกรรมกลุ่มกับนักศึกษา",
  ...
  builds: {
    lawcu: {
      ...
      desc: "แพลตฟอร์มที่ผมสร้างเพื่อสอน AI ให้นักศึกษากฎหมายระดับบัณฑิตศึกษาที่จุฬาฯ ด้วยผู้เรียนราว 400 คน มันต้องรองรับการใช้งานพร้อมกันประมาณ 400 คนได้",
    },
    estimatedTax: {
      name: "Estimated Tax",
    ...
    distributed: {
      name: "Distributed Learning System",
      meta: "University of Toronto · Java",
      desc: "โปรเจกต์สมัยเรียน ระบบกระจายที่ซิงก์การเขียนและการวาดข้ามอุปกรณ์ เพื่อการเรียนรู้ร่วมกันแบบเรียลไทม์",
    },
    priorityGo: {
      name: "Priority Go!",
      meta: "Microsoft Hackathon · C#",
      desc: "แอปบน Windows ที่แนะนำลำดับสถานที่ที่ควรไปให้เหมาะที่สุด โดยใช้ข้อมูลจากผู้ใช้และข้อมูลสด Bing Maps",
    },
    nluBot: {
      name: "NLU Chat Bot",
      meta: "Microsoft Hackathon · C# · LUIS",
  ...
  chat: {
    ...
    suggested: [
      ...
      "เขาเคยทำผลิตภัณฑ์ด้านการปฏิบัติตามข้อกำหนดไหม?",
