...
const th: Strings = {
  ...
  hero: {
    ...
    lead: "สวัสดีครับ ผมวิน เป็น product manager ที่ชอบงานแพลตฟอร์มเชิงเทคนิคและปัญหาเทคโนโลยีที่ยังไม่มีคำตอบ ผมชอบสร้างเครื่องมือที่ช่วยให้คนทำงานได้อย่างมีประสิทธิภาพมากขึ้น ทั้งด้านแพลตฟอร์มข้อมูล เทคโนโลยีกฎหมายและการปฏิบัติตามข้อกำหนด และเครื่องมือสำหรับนักเทคโนโลยี",
  ...
  roles: {
    ...
    vanta: {
      ...
      bullets: [
        ...
        "นำการค้นคว้าและเปิดตัวการทดสอบและการเชื่อมต่อแบบกำหนดเองรายแรกของวงการตั้งแต่ศูนย์ (0→1) ให้ลูกค้าตรวจสอบมาตรฐานใดก็ได้บน Vanta และขยายตลาด",
      ...
      metrics: ["AI", "การปฏิบัติตามข้อกำหนด", "ข้อมูล", "แพลตฟอร์ม", "การเชื่อมต่อ", "ความปลอดภัยไซเบอร์", "0 ถึง 1"],
    },
    mt: {
      co: "Modern Treasury",
      title: "Senior Product Manager, Foundations",
    ...
    msft: {
      ...
      metrics: ["การปฏิบัติตามข้อกำหนด", "ข้อมูล", "เครื่องมือนักพัฒนา", "แพลตฟอร์ม", "GDPR", "คุณภาพข้อมูล", "ข้อมูลเชิงวินิจฉัย"],
    },
    motorola: {
      co: "Motorola Solutions",
      title: "Jr. Software Developer",
  ...
  teaching: {
    ...
    paragraphs: [
      "ทุกปีผมกลับกรุงเทพฯ หนึ่งสัปดาห์เพื่อสอนใน{strong}หลักสูตร LLBel ที่จุฬาลงกรณ์มหาวิทยาลัย{/strong} ซึ่งเป็นบูตแคมป์เข้มข้นสำหรับนักศึกษากฎหมาย ผมสอนการบริหารผลิตภัณฑ์ การคิดเชิงออกแบบ และเล่าว่าวงการเทคโนโลยีทำงานกันอย่างไร เพื่อให้นักกฎหมายและผู้กำกับดูแลในอนาคตเข้าใจระบบที่พวกเขาจะให้คำปรึกษาและกำกับดูแล",
  ...
  builds: {
    lawcu: {
      ...
      desc: "แพลตฟอร์มที่ผมสร้างเพื่อสอน AI ให้นักศึกษากฎหมายระดับบัณฑิตศึกษาที่จุฬาฯ ต้องรองรับนักศึกษาราว 400 คนที่ใช้งานพร้อมกันได้",
    },
    estimatedTax: {
      name: "Estimated Tax",
